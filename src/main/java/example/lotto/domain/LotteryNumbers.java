...
import example.lotto.error.DuplicateLottoNumberException;
import example.lotto.error.ErrorMessage;
import example.lotto.error.InvalidLottoSizeException;
import example.lotto.error.LottoNumberOutOfRangeException;
